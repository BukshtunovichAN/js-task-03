...
})({"7ccRg":[function(require,module,exports) {
...
const cardsMarkup = createGalleryCards((0, _galleryItems.galleryItems));
gallaryContainer.insertAdjacentHTML("beforeend", cardsMarkup);
gallaryContainer.addEventListener("click", onGalleryClick);
let options = new (0, _simplelightboxDefault.default)(".gallery a", {
    captionType: "attr",
    captionSelector: "img",
    captionsData: "alt",
    captionDelay: 250
...
},{}]},["7ccRg","6XVkV"], "6XVkV", "parcelRequire53b6")
